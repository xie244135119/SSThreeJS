...
class PathGeometry extends BufferGeometry {
  ...
  _initByMaxVertex(maxVertex, generateUv2) {
    this.setAttribute(
      'position',
      new BufferAttribute(new Float32Array(maxVertex * 3), 3).setUsage(DynamicDrawUsage)
    );
    this.setAttribute(
      'normal',
      new BufferAttribute(new Float32Array(maxVertex * 3), 3).setUsage(DynamicDrawUsage)
    ...
    this.setAttribute(
      'uv',
      new BufferAttribute(new Float32Array(maxVertex * 2), 2).setUsage(DynamicDrawUsage)
    );
    if (generateUv2) {
      this.setAttribute(
        'uv2',
  ...
  _initByData(pathPointList, options = {}, usage, generateUv2) {
    ...
    if (vertexData && vertexData.count !== 0) {
      ...
      this.setAttribute(
        'uv',
        new BufferAttribute(new Float32Array(vertexData.uv), 2).setUsage(usage || StaticDrawUsage)
      );
      if (generateUv2) {
        this.setAttribute(
          'uv2',
