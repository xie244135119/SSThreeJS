...
class UIElement {
  ...
  setClass(name) {
    this.dom.className = styles[name];
...
class UIText extends UISpan {
  constructor(text) {
    ...
    this.dom.className = styles.Text;
...
class UIInput extends UIElement {
  constructor(text) {
    ...
    this.dom.className = styles.Input;
...
class UITextArea extends UIElement {
  constructor() {
    ...
    this.dom.className = styles.TextArea;
    this.dom.style.padding = '2px';
...
class UISelect extends UIElement {
  constructor() {
    ...
    this.dom.className = styles.Select;
    this.dom.style.padding = '2px';
...
class UICheckbox extends UIElement {
  constructor(boolean) {
    ...
    this.dom.className = styles.Checkbox;
...
class UIColor extends UIElement {
  constructor() {
    ...
    this.dom.className = styles.Color;
...
class UINumber extends UIElement {
  constructor(number) {
    ...
    this.dom.className = styles.Number;
    this.dom.value = '0.00';
...
class UIBreak extends UIElement {
  constructor() {
    ...
    this.dom.className = styles.Break;
  }
}
...
class UIHorizontalRule extends UIElement {
  constructor() {
    ...
    this.dom.className = styles.HorizontalRule;
  }
}
...
class UIButton extends UIElement {
  constructor(value) {
    ...
    this.dom.className = styles.Button;
    this.dom.textContent = value;
  }
}
...
class UITabbedPanel extends UIDiv {
  constructor() {
    ...
    this.dom.className = styles.TabbedPanel;
...
class UIListbox extends UIDiv {
  constructor() {
    ...
    this.dom.className = styles.Listbox;
    this.dom.tabIndex = 0;
...
class ListboxItem extends UIDiv {
  constructor(parent) {
    ...
    this.dom.className = styles.ListboxItem;
