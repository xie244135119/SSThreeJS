  ...
  }(
    {
          ...
          SDPUtils.getIceParameters = function (mediaSection, sessionpart) {
            ...
            const iceParameters = {
              usernameFragment: lines
                .filter((line) => line.indexOf('a=ice-ufrag:') === 0)[0]
                .substr(12),
              password: lines
                .filter((line) => line.indexOf('a=ice-pwd:') === 0)[0]
                .substr(10)
            };
        ...
        function (require, module, exports) {
          ...
          module.exports = function (window, edgeVersion) {
            ...
            function addTrackToStreamAndFireEvent(track, stream) {
              ...
              stream.dispatchEvent(new window.MediaStreamTrackEvent('addtrack', { track }));
            }

            function removeTrackFromStreamAndFireEvent(track, stream) {
              stream.removeTrack(track);
              stream.dispatchEvent(
                new window.MediaStreamTrackEvent('removetrack', { track })
              );
            }
            ...
            RTCPeerConnection.prototype._gather = function (mid, sdpMLineIndex) {
              ...
              iceGatherer.onlocalcandidate = function (evt) {
                ...
                const sections = SDPUtils.getMediaSections(pc.localDescription.sdp);
                if (!end) {
                ...
                pc.localDescription.sdp =
                  SDPUtils.getDescription(pc.localDescription.sdp) + sections.join('');
            ...
            RTCPeerConnection.prototype.setRemoteDescription = function (description) {
              ...
              sections.forEach((mediaSection, sdpMLineIndex) => {
                ...
                const isComplete =
                  SDPUtils.matchPrefix(mediaSection, 'a=end-of-candidates', sessionpart).length > 0;
      ...
      */
            ...
            RTCPeerConnection.prototype.createAnswer = function () {
              ...
              const mediaSectionsInOffer = SDPUtils.getMediaSections(pc.remoteDescription.sdp).length;
              pc.transceivers.forEach((transceiver, sdpMLineIndex) => {
                ...
                if (!pc.remoteDescription) {
                  ...
                  for (let j = 0; j < pc.transceivers.length; j++) {
                    ...
                    pc.remoteDescription.sdp =
                      SDPUtils.getDescription(pc.remoteDescription.sdp) + sections.join('');
                    if (pc.usingBundle) {
                      break;
                    }
                  }
            ...
            shimAddTrackRemoveTrack(window) {
              ...
              ['createOffer', 'createAnswer'].forEach((method) => {
                ...
                window.RTCPeerConnection.prototype[method] = function () {
                  ...
                  return nativeMethod.apply(pc, arguments).then((description) => replaceInternalStreamId(pc, description));
                };
              });
        ...
        function (require, module, exports) {
          ...
          module.exports = {
            ...
            shimCreateObjectURL(window) {
              ...
              const dsc = Object.getOwnPropertyDescriptor(window.HTMLMediaElement.prototype, 'src');
        ...
        function (require, module, exports) {
          ...
          module.exports = function (window) {
            ...
            const getUserMedia_ = function (constraints, onSuccess, onError) {
              const constraintsToFF37_ = function (c) {
                ...
                Object.keys(c).forEach((key) => {
                  ...
                  const r = (c[key] = typeof c[key] === 'object' ? c[key] : { ideal: c[key] });
            ...
            if (browserDetails.version < 41) {
              ...
              const orgEnumerateDevices = navigator.mediaDevices.enumerateDevices.bind(
                navigator.mediaDevices
              );
