...
import { UIButton, UIInput, UIPanel, UIRow, UISelect, UIText, UITextArea } from '../../../UIKit/UI';
import SEComponent from '../../../SEComponent';
import SECommands from '../../../Command/commands';
import UIMaterialBox from '../../../UIKit/UI.MaterialBox';
...
export default class SEPropertyMaterial extends SEComponent {
  ...
  // propertys = [
  //   {
  //     stringKey: 'sidebar/material/slot',
  //     width: '170px',
  //     fontSize: '12px',
  //     type: 'select',
  //     style: {},
  ...
  //   //   const property = this.propertys[index];

  //   //   const row = new UIRow();
  //   //   container.add(row);

  //   //   // 名称
  //   //   const text = new UIText(strings.getKey(property.stringKey));
  //   //   text.setWidth('90px');
  //   //   row.add(text);
  ...
  //   //         if (property.width) {
  //   //           select.setWidth(property.width);
  //   //         }
  //   //         if (property.fontSize) {
  //   //           select.setFontSize(property.fontSize);
  //   //         }
  //   //         if (property.options) {
  //   //           select.setOptions(property.options).setValue(0);
  //   //         }
  //   //         row.add(select);
  //   //       }
  //   //       break;
  ...
  //   const materialUUIDRenew = new UIButton(strings.getKey('sidebar/material/new')).setMarginLeft(
  //     '7px'
  //   );
  ...
  //       new SECommands.SetMaterialValueCommand(
  //         editor,
  //         currentObject,
  //         'uuid',
  ...
  //   const materialClearcoatMap = new SidebarMaterialMapProperty(
  //     editor,
  //     'clearcoatMap',
  //     strings.getKey('sidebar/material/clearcoatmap')
  //   );
  ...
  //   const materialClearcoatRoughnessMap = new SidebarMaterialMapProperty(
  //     editor,
  //     'clearcoatRoughnessMap',
  //     strings.getKey('sidebar/material/clearcoatroughnessmap')
  //   );
  ...
  //   const materialForceSinglePass = new SidebarMaterialBooleanProperty(
  //     editor,
  //     'forceSinglePass',
  //     strings.getKey('sidebar/material/forcesinglepass')
  //   );
  ...
  //         editor.execute(
  //           new SetMaterialCommand(editor, currentObject, material, currentMaterialSlot),
      ...
      object.traverse((e) => {
        if (e instanceof THREE.Mesh) {
          if (Array.isArray(e.material)) {
            list.push(...e.material);
          } else {
            list.push(e.material);
          }
        }
      });
      console.log(' 材质列表 ', list);
  ...
  addMaterials = (options = []) => {
    options.forEach((e) => {
      const materialBox = new UIMaterialBox(e, this.controller);
      // materialBox.setOptions([]);
      console.log(' materialBox ');
      this.uiDom.add(materialBox);
    });
  };
