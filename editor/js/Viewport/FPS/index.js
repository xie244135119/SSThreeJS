...
import { UIPanel, UIBreak, UIText } from '../../UIKit/UI';

export default class SSViewportFPS extends SEComponent {
  /**
   * 物体数量
   * @@type {UIText}
   */
  ...
  destory() {
    this.controller.signals.sceneGraphChanged.remove(this.update);
    this.controller.signals.sceneRendered.remove(this.updateFrametime);
    super.destory();
  }
  ...
  constructor(controller) {
    ...
    // this.controller.signals.objectAdded.add(this.update);
    // this.controller.signals.objectRemoved.add(this.update);
    // this.controller.signals.geometryChanged.add(this.update);
    this.controller.signals.sceneGraphChanged.add(this.update);
    this.controller.signals.sceneRendered.add(this.updateFrametime);
  }
