...
import SSCommand from './Command/Index';
import SSComponent from './SSComponent';

export default class SSMenubarAdd extends SSComponent {
  //
  constructor(controller) {
    ...
    option.onClick(() => {
      ...
      this.controller.execute(new SSCommand.AddObjectCommand(this.controller, mesh));
    });
    options.add(option);
    ...
    option = new UIRow();
    option.setClass('option');
    option.setTextContent('dodecahedron');
    option.onClick(() => {
    ...
    option = new UIRow();
    option.setClass('option');
    option.setTextContent('octahedron');
    option.onClick(() => {
    ...
    option.onClick(() => {
      ...
      this.controller.execute(new SSCommand.AddObjectCommand(this.controller, sprite));
    });
    options.add(option);
    ...
    option = new UIRow();
    option.setClass('option');
    option.setTextContent('tetrahedron');
    option.onClick(() => {
    ...
    option.onClick(() => {
      ...
      this.controller.execute(new SSCommand.AddObjectCommand(this.controller, light));
    });
    options.add(option);
    ...
    option = new UIRow();
    option.setClass('option');
    option.setTextContent('orthographiccamera');
    option.onClick(() => {
      const { aspect } = this.controller.camera;
      const camera = new THREE.OrthographicCamera(-aspect, aspect);
      camera.name = 'OrthographicCamera';

      this.controller.execute(new SSCommand.AddObjectCommand(this.controller, camera));
    });
    options.add(option);
